...
/// A parsed blocking condition BEFORE resolution to `VociCore.Condition`. `taskDone` references a
...
extension ParsedCondition: Codable {
    /// Hand-rolled (same convention as `VociTask.ConditionDTO` / `Recurrence`'s Codable) so the
