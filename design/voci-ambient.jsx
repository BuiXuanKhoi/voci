// voci-ambient.jsx — ambient focus backgrounds (rain/snow/fireflies/custom image),
    ...
    <div style={{
      ...
      {mode === 'custom' && !imageUrl && (
        <div style={{
          ...
          color: 'rgba(255,255,255,0.28)', fontFamily: VOCI_MONO, fontSize: 12, letterSpacing: '0.04em',
...
function vociStopSpeak() {
  try { window.speechSynthesis && window.speechSynthesis.cancel(); } catch (e) {}
}

Object.assign(window, { AmbientBackground, AMBIENT_MODES, useAmbientSound, vociSpeak, vociStopSpeak });
