...
/// A pure, immutable snapshot of a task, as consumed by the `VolarCore` selection engine.
///
...
/// model (e.g. a SwiftData `@Model`) into this value type before calling into `VolarCore`.
