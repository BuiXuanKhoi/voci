...
private final class AppleSignInCoordinator: NSObject, ASAuthorizationControllerDelegate, ASAuthorizationControllerPresentationContextProviding {
    ...
    func presentationAnchor(for controller: ASAuthorizationController) -> ASPresentationAnchor {
        ...
        #elseif os(iOS)
        // UNVERIFIED: UIWindowScene.keyWindow (iOS 15+) is the documented replacement for the
        // deprecated UIApplication.shared.keyWindow; ASPresentationAnchor == UIWindow on iOS. Not
        // exercised on a real device/simulator from this machine.
