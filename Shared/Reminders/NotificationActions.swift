...
enum ReminderAction {
    static let done = "VOLAR_REMINDER_DONE"
    static let snooze10 = "VOLAR_REMINDER_SNOOZE_10"
    static let tomorrow = "VOLAR_REMINDER_TOMORROW"
    static let rescheduleTonight = "VOLAR_RESCHEDULE_TONIGHT"
    static let rescheduleTomorrow = "VOLAR_RESCHEDULE_TOMORROW"
    static let rescheduleWeekend = "VOLAR_RESCHEDULE_WEEKEND"
}
...
enum NotificationActions {
    ...
    /// (`Sources/App/VolarApp.swift`, App-wiring-owned) — this file does not call it itself so it
